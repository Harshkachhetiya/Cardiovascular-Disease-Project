...
<div class="pro-badge">
<span class="pro-pulse-dot" style="background: #38BDF8; box-shadow: 0 0 10px #38BDF8;"></span> ACADEMIC SPECIFICATIONS &bull; ML PROJECT
</div>
...
Undergraduate Machine Learning Project engineered strictly in accordance with Darshan University Computer Engineering Department ML Project Standard Operating Procedure (SOP).
    ...
    # Author Card — moved to top for prominence
    st.markdown("""<div class="vercel-card" style="text-align: center; padding: 34px 24px; position: relative; overflow: hidden; margin-bottom: 24px;">
<div style="position: absolute; top: 0; left: 0; right: 0; height: 3px; background: linear-gradient(90deg, #7C3AED, #A78BFA, #7C3AED);"></div>
<div style="width: 52px; height: 52px; border-radius: 14px; background: linear-gradient(135deg, #A78BFA 0%, #7C3AED 100%); display: inline-flex; align-items: center; justify-content: center; font-size: 24px; box-shadow: 0 0 20px rgba(124,58,237,0.5); margin-bottom: 16px;">
🎓
</div>
<div style="font-size: 22px; font-weight: 800; color: #FFFFFF; letter-spacing: -0.5px; margin-bottom: 4px;">
Darshan University
</div>
<div style="font-size: 14.5px; font-weight: 600; color: #A78BFA; margin-bottom: 14px;">
...
Student Developer: <b style="color: #FFFFFF; font-size: 15px;">Harsh Kachhetiya</b><br>
...
<span class="trust-tag">✅ High-Performance Interactive UI</span>
    ...
    st.markdown("""<div class="vercel-card" style="margin-bottom: 24px; border-left: 3px solid #7C3AED; padding: 26px 30px;">
